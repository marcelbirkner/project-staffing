...
// Pass this if window is not defined yet
    ...
    ((window => {
        ...
        var // Use a stripped-down indexOf as it's faster than native
        ...
        var // Attribute selectors: http://www.w3.org/TR/selectors/#attribute-selectors
        ...
        setDocument = Sizzle.setDocument = node => {
            ...
            Expr.find["TAG"] = support.getElementsByTagName ?
                ...
                (tag, context) => {
                    ...
                    var // By happy coincidence, a (broken) gEBTN appears on DocumentFragment nodes too
        ...
        function matcherFromTokens( tokens ) {
            ...
            var matchAnyContext = addCombinator( elem => indexOf( checkContext, elem ) > -1, implicitRelative, true );

            var matchers = [ (elem, context, xml) => {
    ...
    var // Segment location into parts
